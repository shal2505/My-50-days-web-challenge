    ...
    form.addEventListener("submit", async function (e) {
       ...
       submitButton.textContent = "Submitting...";
        ...
        try {
            ...
            const result =
    await submitInitiative(newInitiative);
...
async function handleUpdateInitiative(id) {
    ...
    const updatedInitiative = {
        ...
        title:
            "Updated Technical Initiative [UPDATED]",
...
function liveTerminalPage() {
    ...
    return `
        <section class="router-page">
            ...
            <h1>Live WebSocket Terminal</h1>

            <p>
                Send and receive messages in real time using WebSockets.
            </p>

            <div class="websocket-terminal">
...
function homePage() {
    ...
    return `
        ...
        <section id="about-preview" class="hidden">
            ...
            <a href="/about" class="read-more nav-link">
                Read More →
            </a>
...
<section id="data-section" class="hidden">
    ...
    <p>
        Explore the latest posts from the Synexus community.
    </p>

    <div id="data-feed" class="initiatives-grid"></div>
...
function webComponentsPage() {
    ...
    return `
        ...
        <section class="web-components-page">
            ...
            <div class="page-header">
                ...
                <p>
                    Building reusable UI components using
                    Vanilla JavaScript and Shadow DOM.
                </p>
            ...
            <div class="component-demo">
                ...
                <h2>Reusable User Cards</h2>

                <p>
                    These cards are created using a native
                    custom HTML element.
                </p>
                ...
                <div class="user-card-container">
                    ...
                    <user-card
                        name="Abhay Aditya"
                        role="Chief Coordination Officer">
                    </user-card>
                ...
                <div class="global-state-demo">
                    ...
                    <p>
                        Managing shared application state using
                        the Pub/Sub pattern.
                    </p>
                    ...
                    <div class="state-card">
                        ...
                        <p>
                            Theme:
                            <strong id="user-theme">light</strong>
                        </p>


                        <div class="state-buttons">

                            <button id="increase-cart">
                                🛒 Add Item
                            </button>

                            <button id="remove-cart">
                                🗑️ Remove Item
                            </button>
...
let day41Worker = null;

// ==========================================
// DAY 41 - WEB WORKER SETUP
// ==========================================
...
function setupWebWorker() {
    ...
    const cancelBtn =
        document.getElementById("cancel-process-btn");

    const workerResult =
        document.getElementById("worker-result");
...
function setupWebComponentsPage() {
...
function setupGlobalState() {
    ...
    const userTheme =
        document.getElementById("user-theme");

    const increaseCart =
        document.getElementById("increase-cart");

    const removeCart =
        document.getElementById("remove-cart");
    ...
    if (increaseCart) {
        ...
        increaseCart.addEventListener("click", () => {
    ...
    if (removeCart) {
        ...
        removeCart.addEventListener("click", () => {
            ...
            console.log(
                "Current count:",
                globalStore.state.cartCount
            );


            if (globalStore.state.cartCount > 0) {
    ...
    if (changeTheme) {
        ...
        changeTheme.addEventListener("click", () => {
            ...
            const newTheme =
                globalStore.state.userTheme === "light"
                    ? "dark"
                    : "light";
...
function webWorkerPage() {
    ...
    return `
        ...
        <section class="router-page worker-page">
...
// ==========================================
// SERVICE WORKER REGISTRATION - DAY 39
// ==========================================
...
// ==========================================
// BONUS: CHECK OFFLINE DATA WHEN ONLINE
// ==========================================
